...
export enum IconSubset {
  ...
  cilMedicalCross = 'cil-medical-cross',
  cilIndustry = 'cil-industry',
  cilHospital ='cil-hospital',
  cilWarning = 'cil-warning',
  cilAccountLogout ='cil-account-logout',
  cilChatBubble = 'cil-chat-bubble',
  cilPhone = 'cil-phone',
  cilWindowRestore = "cil-window-restore",
  cilScreenSmartphone = 'cil-screen-smartphone'
